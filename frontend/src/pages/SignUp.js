    ...
    <StyledWrapper theme={theme}>
      <form className="form_container" onSubmit={handleSubmit}>
        ...
        <div className="title_container">
          ...
          <span className="subtitle">Sign up to get started with Nimbus and experience emotion recognition in action.</span>
        </div>
        ...
        <div className="input_container">
          ...
          <svg fill="none" viewBox="0 0 24 24" height={24} width={24} xmlns="http://www.w3.org/2000/svg" className="icon">
            ...
            <ellipse cx="12" cy="17" rx="6" ry="4" stroke="#2563eb" strokeWidth="1.5" />
          </svg>
          <input
        ...
        <div className="input_container">
          <label className="input_label" htmlFor="signup_form_email_field">Email</label>
          <svg fill="none" viewBox="0 0 24 24" height={24} width={24} xmlns="http://www.w3.org/2000/svg" className="icon">
        ...
        <div className="input_container">
          <label className="input_label" htmlFor="signup_form_password_field">Password</label>
          <svg fill="none" viewBox="0 0 24 24" height={24} width={24} xmlns="http://www.w3.org/2000/svg" className="icon">
        ...
        <p className="note">
          Already have an account? <a href="/login" style={{ color: '#3A59D1', textDecoration: 'underline' }}>Login</a>
        </p>
      </form>
    </StyledWrapper>
  );
